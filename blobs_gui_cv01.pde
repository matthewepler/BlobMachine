...
void draw()
{
  ...
  if ( detectBlobs )
  {
    ...
    currentImage = loadImage( files[ currentFrame ] );
...
void initGui()
{
  ...
  //SIZE SETTINGS
  //overall stroke
  controlP5.Textfield strokeSize = controlP5.addTextfield( "strokeSize", horizMargin + 225, 705, colorBoxLength, boxHeight );
  ...
  //centroid
  controlP5.Textfield centrSize = controlP5.addTextfield( "centrSize", horizMargin + 225, 730, colorBoxLength, boxHeight );
  ...
  //text
  controlP5.Textfield centrTextSize = controlP5.addTextfield( "centrTextSize", horizMargin + 225, 755, colorBoxLength, boxHeight );
  ...
  //EXPORT
  controlP5.Toggle includeOrigImage = controlP5.addToggle( "includeOrigImage", false, horizMargin, 840, 20, 20 );
  includeOrigImage.setCaptionLabel( "Include Original Image w/ Alpha" );
  includeOrigImage.captionLabel().style().setMarginLeft( 25 ).setMarginTop( -23 );

  controlP5.Button exportOne = controlP5.addButton( "exportOne", 0, horizMargin, 875, 140, boxHeight * 2 );
  //exportOne.setValue( 0 );
